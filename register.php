            ...
            <div class="div-container">
                ...
                <div class="box">
                    <div class="div-checkbox">
                        <input type="radio" name="planId" id="diario" class="checkbox" value="20.00">
                    </div>
                    <h3>Diário</h3>
                    <div class="div-value">
                ...
                <div class="box">
                    <div class="div-checkbox">
                        <input type="radio" name="planId" id="mensal" class="checkbox" value="80.00">
                    </div>
                    <h3>Mensal</h3>
                    <div class="div-value">
                ...
                <div class="box">
                    <div class="div-checkbox">
                        <input type="radio" name="planId" id="anual" class="checkbox" value="900.00">
                    </div>
                    <h3>Anual</h3>
                    <div class="div-value">
